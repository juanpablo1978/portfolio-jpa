...
const SlideServices = () => {
  return (
    <section
      className="min-h-screen grid grid-cols-1 gap-y-10 mt-5 md:grid-cols-2 md:gap-7
    lg:grid-cols-3 bg-gradient-to-r from-blue-950 to-black lg:gap-10"
    >
      {serviceData.map((service) => {
        return (
          <article
            className="w-[300px] h-[430px] md:w-[330px] md:h-[560px] rounded-xl px-6 py-8 lg:h-[410px] lg:w-[450px]
          ...
          >
            ...
            <h2 className="text-[20px] md:text-[25px] text-blue-200">
              {service.title}
            </h2>

            <p className=" text-[16px] md:text-[20px] lg:text-[20px] leading-7 font-normal text-gray-300">
              {service.description}
            </p>
          </article>
        );
