...
const Portfolio = () => {
  return (
    ...
    >
      <h3 className="text-slate-200 text-2xl lg:text-[40px] font-bold text-center pb-9 lg:mb-14">
       ...
       <article className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-16">
        {dataAiko.map((data) => (
          <article
            className="w-[345px] h-[510px] lg:w-[570px] lg:h-[640px] md:w-[350px] md:h-[440px] rounded-md
          ...
          >
            <article
              className="w-[343px] h-[260px] lg:w-[568px] lg:h-[360px] md:w-[335px] md:h-[300px]
               rounded-t-md pb-5 "
            >
              <img
            ...
            <article className=" gap-3 px-3">
              ...
              <p className="text-gray-500 lg:text-xl mb-5">
               ...
               <article className="flex gap-x-8 mt-[26px]">
        ...
        <div className="flex flex-wrap gap-2 px-3 mb-5">
          {data.tecnologias?.map((tec, i) => (
           ...
           hover:bg-blue-900/10 hover:border-blue-500/30 text-teal-200"
            >
              {tec}
            </span>
          ))}
      ...
      <h3 className="text-slate-200 text-2xl lg:text-[40px] font-bold text-center pb-9 mt-14 lg:mb-14">
        Proyectos
      </h3>
      ...
      <article className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-16">
        {dataPortfolio.map((data) => (
          ...
          >
            <article
              className="w-[343px] h-[260px] lg:w-[568px] lg:h-[340px] md:w-[335px] md:h-[300px]
               rounded-t-md pb-5 "
            >
              <img
                className="w-full h-full object-cover rounded-t-md"
            ...
            <article className=" gap-3 px-3">
              ...
              <article className="flex gap-x-12 mt-[26px]">
              <div className="flex gap-x-5 px-3">
                <a
                  href={data.urlGithub}
                  target="_blank"
