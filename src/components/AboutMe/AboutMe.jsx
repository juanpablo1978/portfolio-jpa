...
const AboutMe = () => {
  return (
    <main className="min-h-screen bg-gradient-to-r from-blue-950 to-black pt-52 md:py-40 lg:py-40 flex flex-col text-slate-200">
      <h2 className="text-center py-12 lg:py-0 lg:pb-16 px-2 text-[28px] lg:text-[40px] font-semibold text-slate-200">
        Trayectoria académica y experiencia laboral
      </h2>
      <section className="flex justify-center px-14 gap-5 md:relative lg:relative ">
        <section>
          <RiProgress8Line />
          <div className="h-[550px] lg:h-[295px] md:h-[200px] border-l-2 border-gray-500 ml-2"></div>
          <RiProgress8Line />
          <div className="h-[545px] lg:h-[295px] md:h-[200px]  border-l-2 border-gray-500 ml-2"></div>
          <RiProgress8Line />
          <div className="h-[545px] lg:h-[295px] md:h-[200px]  border-l-2 border-gray-500 ml-2"></div>
          <RiProgress8Line />
        </section>
